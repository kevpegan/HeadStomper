package InfoScreens.Title.MenuButtons 
{
	 ...
	 * @author Kevin Egan
	 */
	public class InstructionsButton extends Sprite
	{
		//parts
		...
		public function InstructionsButton(sX:int, sY:int) 
		{
			stageHeight = sX;
			stageWidth = sY;
		}
		...
		{
			GameApp.eventDispatcher.dispatchEvent(new DisplayInstructions(DisplayInstructions.DISPLAY_INSTRUCTIONS));
		}
